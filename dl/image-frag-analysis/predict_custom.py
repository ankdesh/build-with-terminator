...
def predict():
    ...
    parser.add_argument("--chunks-dir", default="./custom_chunks", help="Directory containing binary chunks.")
    parser.add_argument("--model-path", default="best_cnn_model.pth", help="Path to trained model weights.")
    parser.add_argument("--sector-size", type=int, default=512, help="Sector size used for training.")
    parser.add_argument("--output-csv", default="inference_results.csv", help="Path to save sector-level results.")
