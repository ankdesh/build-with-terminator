# sample-workflows Specification

## Purpose
TBD - created by archiving change sample-workflows. Update Purpose after archive.
## Requirements
### Requirement: Sample Parse and Get Templates Workflow
The repository SHALL provide a sample YAML workflow demonstrating how to parse a log file and retrieve its templates using the `template_extractor` executor.
